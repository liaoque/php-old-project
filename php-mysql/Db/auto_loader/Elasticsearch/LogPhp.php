...
class Elasticsearch_LogPhp extends Elasticsearch_Base
{
    ...
    public function getTableName()
    {
        ...
        if (empty($this->tableName)) {
            if (check_is_test()) {
                $this->tableName = 'logstash-test-api-log';
            } else {
                $this->tableName = 'logstash-master-api-log';
            }
        }
...
//        var_dump($query);exit();
        ...
        $list = array_map(function ($item) {
            ...
            $info = [
                ...
                'extra' => $item['extra'],
                'tags' => $item['tags'],
                'ip' => implode(',', var_def($item['host']['ip'], [])),
